...
public class PrelevementEditorPaneController {
	...
	/**
	 * Méthode appelée lors de l'ouverture de l'interface
	 * d'edition/création/suppession d'un prélèvement
	 * 
	 * @param pvmt prélèvement à éditer ou null si création
	 * @param mode mode d'édition
	 * @return le prélèvement édité ou null si annulation
	 */
	...
	private Object focusDate(ObservableValue<? extends Boolean> txtField, boolean oldPropertyValue,
		...
		if (oldPropertyValue) {
			try {
				...
				this.txtDateRecurrente
						.setText(String.format(Locale.ENGLISH, "%01d", this.prelevementEdite.dateRecurrente));
